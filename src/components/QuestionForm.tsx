...
// ✅ dynamically import RTE to fix module import/type issues
const RTE = dynamic(() => import("@uiw/react-md-editor"), { ssr: false });

// ✅ Custom interface extending Models.Document for type safety
    ...
    <form className="space-y-4" onSubmit={submit}>
      ...
      <LabelInputContainer>
        <Label htmlFor="image">
          Image
          <br />
          <small>Add image to your question for clarity.</small>
        </Label>
        <Input
          id="image"
          name="image"
      ...
      <LabelInputContainer>
        <Label htmlFor="tag">
          Tags
          <br />
          <small>Add tags to describe your question. Start typing to see suggestions.</small>
        </Label>
